...
class _ProgressScreenState extends State<ProgressScreen> {
    ...
    if (_weightLogs.isEmpty) {
      return Card(
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              Icon(Icons.show_chart, size: 60, color: _outline),
              const SizedBox(height: 15),
              Text(
                'No weight data yet',
                style: TextStyle(fontSize: 16, color: _scheme.onSurface),
              ),
              const SizedBox(height: 15),
              ElevatedButton(
  ...
  Widget _buildTimeRangeChip(int days, String label) {
    ...
    return ChoiceChip(
      ...
      side: BorderSide(
        color: isSelected ? _scheme.primary : _outline,
        width: 1.5,
      ),
        ...
        Expanded(
          child: Card(
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  Text('Current', style: TextStyle(color: _scheme.onSurface)),
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  Text(
                    'Total Change',
                    style: TextStyle(color: _scheme.onSurface),
                  ),
                  const SizedBox(height: 5),
                  Text(
